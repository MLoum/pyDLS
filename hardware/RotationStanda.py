...
class RotationStanda(RotationStage):
    ...
    def load_device(self, params=None):
		...
		* For example "xi-com:\\\.\COM3" in Windows or "xi-com:/dev/tty.s123" in Linux/Mac.
        ...
        self.main_ui.write_to_splash_screen("Device count: " + repr(self.dev_count))
        ...
        for dev_ind in range(0, self.dev_count):
            ...
            if result == Result.Ok:
                self.main_ui.write_to_splash_screen("Enumerated device #{} name (port name): ".format(dev_ind) + repr(
        ...
        #
        # self.main_ui.write_to_splash_screen("Open device " + repr(self.open_name_x))
        # self.device_id_x = self.lib.open_device(self.open_name_x)
        # self.main_ui.write_to_splash_screen("Device id: " + repr(self.device_id_x))
        #
        # self.main_ui.write_to_splash_screen("Open device " + repr(self.open_name_y))
        # self.device_id_y = self.lib.open_device(self.open_name_y)
        # self.main_ui.write_to_splash_screen("Device id: " + repr(self.device_id_y))
